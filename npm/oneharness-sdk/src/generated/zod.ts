...
export const FallbackReportSchema: z.ZodType<FallbackReport> = z.looseObject({
  ...
  stopped_without_work: z.boolean().refine((value) => value !== undefined, { message: "Required" }),
});
    ...
    z.intersection(
      z.intersection(
        z.intersection(
          z.union([
            z.looseObject({
              ...
              variant: z.union([z.string(), z.null()]).optional(),
              work: z.union([z.lazy(() => RunWorkSchema), z.null()]).optional(),
            }),
            z.looseObject({
              duration_ms: z
                .int()
            ...
            z.looseObject({
              ...
              prompt: z.string().refine((value) => value !== undefined, { message: "Required" }),
              schema_version: z
                .union([z.literal("1.3"), z.literal("1.4"), z.literal("1.5"), z.literal("1.6"), z.literal("1.7")])
                .refine((value) => value !== undefined, { message: "Required" }),
              session: z.string().refine((value) => value !== undefined, { message: "Required" }),
              session_id: z
                .union([z.string(), z.null()])
        ...
        z.union([
          ...
          z.looseObject({
            schema_version: z.literal("1.7").optional(),
      ...
      z.union([
        ...
        z.looseObject({
          schema_version: z.union([z.literal("1.4"), z.literal("1.5"), z.literal("1.6"), z.literal("1.7")]).optional(),
        }),
      ]),
    ),
    z.intersection(
      z.union([
        ...
        z.looseObject({
          schema_version: z.union([z.literal("1.5"), z.literal("1.6"), z.literal("1.7")]).optional(),
        }),
      ]),
      z.union([
        z.looseObject({
        ...
        z.looseObject({
          schema_version: z.union([z.literal("1.6"), z.literal("1.7")]).optional(),
        }),
      ]),
    ),
  ),
...
export const RunResultSchema: z.ZodType<RunResult> = z.looseObject({
  ...
  work: z
    .union([z.lazy(() => RunWorkSchema), z.null()])
    .refine((value) => value !== undefined, { message: "Required" }),
});
